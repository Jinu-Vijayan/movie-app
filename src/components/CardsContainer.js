...
const CardsContainer = ({containerType,filterOptions,dataStoredIn, setFilter, cardType}) => {
  ...
  return (
    <div >
      <div className='flex justify-between mb-4'>
        ...
        {filterOptions.length > 0 && <div className='flex gap-5 items-center relative bg-white text-black px-5 py-2 rounded-[30px]'>
